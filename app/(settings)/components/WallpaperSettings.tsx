...
export default function WallpaperSettings() {
  ...
  return (
    ...
    >
      ...
      <View style={styles.phoneMockup} className="shadow-sm">
        <View style={styles.phoneFrame}>
          <View style={styles.notch} />
          <View style={styles.deviceStatus}>
            <Text
              style={styles.statusBadge}
              className="font-poppins-semibold text-sm text-green-600"
            >
              <Link className="text-green-500" size={12} /> Connected to device
            </Text>
